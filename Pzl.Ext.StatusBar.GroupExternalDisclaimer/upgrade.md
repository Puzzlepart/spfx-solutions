# Upgrade project C:\code\UpgradeStuff\andre\spfx-solutions\Pzl.Ext.StatusBar.GroupExternalDisclaimer to v1.9.1
...
In file [src\extensions\externalAccessDisclaimer\ExternalAccessDisclaimerApplicationCustomizer.manifest.json](src\extensions\externalAccessDisclaimer\ExternalAccessDisclaimerApplicationCustomizer.manifest.json) update the code as follows:
...
File: [src\extensions\externalAccessDisclaimer\ExternalAccessDisclaimerApplicationCustomizer.manifest.json](src\extensions\externalAccessDisclaimer\ExternalAccessDisclaimerApplicationCustomizer.manifest.json)
...
```sh
npm i -SE @microsoft/sp-core-library@1.9.1 @microsoft/sp-dialog@1.9.1 @microsoft/sp-application-base@1.9.1 @microsoft/decorators@1.9.1 office-ui-fabric-react@6.189.2 @types/webpack-env@1.13.1 @types/es6-promise@0.0.33
...
#### [src\extensions\externalAccessDisclaimer\ExternalAccessDisclaimerApplicationCustomizer.manifest.json](src\extensions\externalAccessDisclaimer\ExternalAccessDisclaimerApplicationCustomizer.manifest.json)
