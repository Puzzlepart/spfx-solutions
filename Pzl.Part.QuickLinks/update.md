# Upgrade project Pzl.Part.QuickLinks to v1.15.2
...
File: [./config/serve.json:2:5](./config/serve.json)
...
File: [./package.json:42:9](./package.json)
...
File: [./package.json:38:9](./package.json)
...
```json
{
  "solution": {
    "metadata": {
      "shortDescription": {
        "default": "pzl-quick-links description"
      },
      "longDescription": {
        "default": "pzl-quick-links description"
      },
...
```json
{
  "solution": {
    "features": [
      {
        "title": "pzl-quick-links Feature",
        "description": "The feature that activates elements of the pzl-quick-links solution.",
        "id": "2a27a4a5-04f8-4e13-8d45-6e9262f6a741",
        "version": "1.3.0.0"
      }
    ]
  }
...
File: [./config/serve.json:5:5](./config/serve.json)
...
File: [./config/serve.json:6:5](./config/serve.json)
...
File: [./package.json:40:9](./package.json)
