define([], function () {
  return {
    PropertyPane: {
      ...
      ButtonAppearanceSecondaryLabel: 'Secondary',
      ButtonAppearancePrimaryLabel: 'Primary',
      ButtonAppearanceOutlineLabel: 'Outline',
      ButtonAppearanceSubtleLabel: 'Subtle',
    ...
    CategoryFallbackLabel: 'Your links',
