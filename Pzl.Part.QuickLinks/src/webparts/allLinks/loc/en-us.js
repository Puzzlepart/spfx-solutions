define([], function () {
  return {
    propertyPane_defaultOfficeFabricIcon: "Default icon",
    ...
    propertyPane_RecommendedLinksTitleLabel: "Title for 'Recommended links'",
    propertyPane_MyLinksTitleLabel: "Title for 'Your links'",
    component_RecommendedLinksLabel: "Recommended links",
    component_MandatoryLinksLabel: "Mandatory links",
    component_YourLinksLabel: "Your links",
    component_SaveYourLinksLabel: "Save your links",
    component_NewLinkLabel: "New link",
    component_TitleLabel: "Title",
    component_AddLabel: "Add",
    component_CancelLabel: "Cancel",
    component_UrlValidationLabel: "Please add a proper URL.",
