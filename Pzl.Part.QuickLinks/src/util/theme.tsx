...
const brandVariants: BrandVariants = {
  10: pSBC(-0.4, primaryColor),
  20: pSBC(-0.35, primaryColor),
  30: pSBC(-0.3, primaryColor),
  40: pSBC(-0.25, primaryColor),
  50: pSBC(-0.2, primaryColor),
  60: pSBC(-0.15, primaryColor),
  70: pSBC(-0.1, primaryColor),
  80: pSBC(-0.05, primaryColor),
  90: primaryColor,
